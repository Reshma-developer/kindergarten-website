                  ...
                  <div class="container">
                    <div class="row">
                      <div class="col-sm-12 col-md-8 col-lg-8 col-12">
                        <h1 class="text2 text-white mb-4">Facilities</h1>
...
<div class="col-sm-12 col-md-3 col-lg-3 col-12">
  <div class="facility_item">
    <div class="facility_icon bg-primary">
      <span class="bg-primary"></span>
    <i class="fa-solid fa-bus fa-3x text-white"></i>
    <span class="bg-primary"></span>
  </div>
  <div class="facility_text bg-primary">
    <h3 class="text-white mb-3">School Bus</h3>
...
<div class="col-sm-12 col-md-3 col-lg-3 col-12">
  <div class="facility_item">
    <div class="facility_icon bg-warning">
      <span class="bg-primary"></span>
      <i class="fa-solid fa-basketball fa-3x text-white"></i>
    <span class="bg-primary"></span>
  </div>
  <div class="facility_text bg-warning">
    <h3 class="text-white mb-3">Playground</h3>
    <p class="mb-0">Eirmod sed ipsum dolor sit rebum magna erat lorem kasd vero ipsum sit</p>
  </div>
  </div>
</div>
...
<div class="col-sm-12 col-md-3 col-lg-3 col-12">
  <div class="facility_item">
    <div class="facility_icon bg-success">
      <span class="bg-primary"></span>
      <i class="fa-solid fa-bowl-rice fa-3x text-white"></i>
    <span class="bg-primary"></span>
  </div>
  <div class="facility_text bg-success">
    <h3 class="text-white mb-3">Healthy Canteen</h3>
    <p class="mb-0">Eirmod sed ipsum dolor sit rebum magna erat lorem kasd vero ipsum sit</p>
  </div>
  </div>
</div>
...
<div class="col-sm-12 col-md-3 col-lg-3 col-12">
  <div class="facility_item">
    <div class="facility_icon bg-danger">
      <span class="bg-primary"></span>
      <i class="fa-solid fa-chalkboard-user fa-3x text-white"></i>
    <span class="bg-primary"></span>
  </div>
  <div class="facility_text bg-danger">
    <h3 class="text-white mb-3">Positive Learning</h3>
    <p class="mb-0">Eirmod sed ipsum dolor sit rebum magna erat lorem kasd vero ipsum sit</p>
  </div>
  </div>
</div>
