                  ...
                  <div class="container">
                    <div class="row">
                      <div class="col-sm-12 col-md-8 col-lg-8 col-12">
                        <h1 class="text2 text-white mb-4">Popular Teacher</h1>
...
<div class="container-xxl py-5">
  ...
  <h1 class="mb-3">Popular Teacher</h1>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-4 col-lg-4 col-12">
       <!-- <div class="img1 rounded-circle bg-primary align-items-center w-75"> -->
        <img  class="img-fluid rounded-circle ms-4 " src="./images/teacher4.jpg" alt="teacher">
        <div class="text-img">
          <h5>Name:Alka</h5>
          <h5>Designation:Science Teacher</h5>
        </div>
      </div>
    
    <div class="col-sm-12 col-md-4 col-lg-4 col-12">
      <!-- <div class="img1 rounded-circle bg-primary align-items-center w-75"> -->
        <img  class="img-fluid rounded-circle ms-4"  style="height:230px; width: 230px;" src="./images/teacher3.webp" alt="teacher">
        <div class="text-img">
          <h5>Name:Meera</h5>
          <h5>Designation:English Teacher</h5>
        </div>
      </div>
        
    <div class="col-sm-12 col-md-4 col-lg-4 col-12">
      <!-- <div class="img1 rounded-circle bg-primary align-items-center w-75"> -->
        <img  class="img-fluid rounded-circle ms-4" style="height: 230px;" src="./images/teacher1.jpg" alt="teacher">
        <div class="text-img">
          <h5>Name:Roshani</h5>
          <h5>Designation:Maths Teacher</h5>
        </div>
      </div>
    </div>
  </div>
